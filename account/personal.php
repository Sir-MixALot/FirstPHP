    ...
    <body>     
        <div class="wrapper">
            ...
            <div class="content">
                ...
                <form class="changinglogin" action="../vendor/loginchanging.php" method="post">
                    ...
                    ?>
                    <button id="button5"><span>Change</span></button>
                    <label id="label1">Your Email: <?= $_SESSION['user']['email'] ?></label>
                </form>
            </div>
    </body>
</html>